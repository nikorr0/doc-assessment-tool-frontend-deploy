...
**Демонстрационная версия веб-интерфейса:** [https://doc-assessment-tool-frontend-deploy.vercel.app/](https://doc-assessment-tool-frontend-deploy.vercel.app/)
...
Проект разработан по запросу научно-технического отдела университета с целью автоматизации обработки отчётных документов, контроля выполнения поставленных задач и поддержки управленческой деятельности посредством аналитического дашборда.
...
> **Примечание.** Изображения ниже отражают фактический вид интерфейса системы. Все отображаемые в них данные (названия проектов, исполнители, задачи, показатели и т.п.) являются сгенерированными и не относятся к реальным проектам.

## Веб-интерфейс

### Страница создания проекта
<p align="center">
 <img src="images/web_interface_project_creation_page.png" style="align-self:center;">
</p>

### Страница проекта и загрузка приказа
<p align="center">
 <img src="images/web_interface_order_loading_page.png" style="align-self:center;">
</p>

### Страница приказа
<p align="center">
 <img src="images/web_interface_order_page.png" style="align-self:center;">
</p>

### Список задач группы
<p align="center">
 <img src="images/web_interface_order_tasks_page.png" style="align-self:center;">
</p>

### Цифровой портрет проекта (дашборд)
<p align="center">
 <img src="images/web_interface_dashboard.png" style="align-self:center;">
</p>
