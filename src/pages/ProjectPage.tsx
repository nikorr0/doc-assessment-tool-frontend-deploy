...
export default function ProjectPage() {
  ...
  return (
    <div className="project-page">
      ...
      <h1 className="page-title">Проект "{project?.shortName ?? project?.name}"</h1>
        ...
        <div className="card">
          ...
          <div className="project-view-grid">
            <div className="project-view-field" style={{ gridColumn: "1 / -1" }}>
              <span className="project-view-label">Краткое наименование проекта: </span>
              <span style={{ fontSize: 14, fontWeight: 500 }}>{project.shortName ?? project.name}</span>
            </div>
            <div className="project-view-field" style={{ gridColumn: "1 / -1" }}>
              <span className="project-view-label">Полное наименование проекта: </span>
              <span style={{ fontSize: 14, fontWeight: 500 }}>
                {project.fullName ?? project.shortName ?? project.name}
              </span>
            </div>
